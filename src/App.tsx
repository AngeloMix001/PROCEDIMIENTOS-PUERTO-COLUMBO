...
const proceduresData = [
  ...
  { id: 3, title: "Procedimientos Almacén Patio", category: "Almacén Patio", date: "Actual", type: "procedure" as const, steps: ["Paso 1: Identificar...", "Paso 2: Segregar..."], pdfUrl: "https://docs.google.com/document/d/1FzTSVaf_IMAGKj-xwN33bgiEZML-GYN6/edit?usp=sharing&ouid=115558709160216474718&rtpof=true&sd=true" },
  ...
  { id: 9, title: "Seguimiento y mantención de equipos y maquinarias", category: "Equipos y Maquinarias", date: "Actual", type: "procedure" as const, steps: ["Paso 1: Verificar el estado de operatividad de los equipos antes de iniciar las operaciones.", "Paso 2: Registrar de inmediato cualquier desperfecto, ruido inusual o falla técnica.", "Paso 3: Programar mantenimientos preventivos periódicos según las especificaciones del fabricante.", "Paso 4: Realizar la mantención correctiva o coordinar con soporte técnico especializado externo.", "Paso 5: Completar y firmar la bitácora de inspección e intervención de los equipos."], pdfUrl: "https://drive.google.com/file/d/1HuAHU9PP_oQFbvqDt6mG8pTGQ8u8Y6H8/view?usp=sharing" },
];
