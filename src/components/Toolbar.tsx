...
import { Search, X, FileText, CheckSquare, Filter, RotateCcw, Workflow } from 'lucide-react';
...
export function Toolbar({
  ...
  return (
    <div className="space-y-4 mb-8">
      ...
      <div className="bg-white rounded-2xl p-3 sm:p-4 border border-slate-200 shadow-xs flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        
        {/* Animated Segmented Tabs */}
        <div className="flex items-center p-1 bg-slate-100 rounded-xl w-full lg:w-auto overflow-x-auto shrink-0 scrollbar-none">
          <button
            onClick={() => onTabChange('procedure')}
            className={`relative flex-1 lg:flex-initial flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-xs sm:text-sm font-bold tracking-wide transition-colors whitespace-nowrap cursor-pointer ${
          ...
          >
            ...
            <CheckSquare className="w-4 h-4 relative z-10 shrink-0" />
          ...
          >
            ...
            <Workflow className="w-4 h-4 relative z-10 shrink-0" />
        ...
        <div className="relative flex-1 max-w-lg">
          ...
          <input
            ...
            placeholder={
              activeTab === 'flowchart'
                ? "Buscar diagrama por código (ej: DF-GC), título o área..."
                : "Buscar por código (ej: PR-GC), título o departamento..."
            }
            value={searchQuery}
